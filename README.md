...
| 版本 | 发布日期 | 下载 | 说明 |
|:----:|:--------:|:----:|:-----|
| v1.6.0 | 2026-05-05 | [📥 下载 APK](releases/app-release1.6.0.apk) | 新增桌面小部件（支持小米）、生物识别/PIN 服务优化、堆叠卡片组件优化 |
| v1.5.7 | 2026-05-04 | — | 重构每日提醒功能，确保每日都能收到准确的最新提醒 |
| v1.5.6 | 2026-05-03 | — | 新增剪贴板账单解析、待还金额管理、待还款卡片快捷切换；优化主题和 Snackbar 样式、通知常驻显示、借记卡银行排序、活动/统计徽章实时刷新 |
| v1.5.5 | 2026-05-01 | — | 新增每日定时提醒、银行自定义排序、活动提醒；优化还款排序、活动状态判断、通知内容、状态保持等 |

### 历史版本

| 版本 | 发布日期 | 下载 | 说明 |
|:----:|:--------:|:----:|:-----|
| v1.5.4 | 2026-04-28 | — | 优化银行管理界面，移除拖动限制，调整颜色选择器参数 |
| v1.5.3 | 2026-04-29 | — | 新增银行管理界面和银行选择器组件，调整优化菜单入口 |
| v1.5.2 | 2026-04-29 | — | 活动增加一键添加到日历日程功能 |
| v1.5.1 | 2026-04-28 | — | 优化活动提醒更新时机 |
| v1.5.0 | 2026-04-28 | — | 新增应用锁、一键智能创建活动、借记卡管理、卡片堆叠切换动画 |
| v1.1.0 | 2026-04-13 | — | 首个公开发布版本 |
...
> - 您可以在捐赠时备注想要的功能或建议
 <div align="center">
<img src="images/w&a.png" width="200"/>
</div>
