...
**信用卡包** 是一款完全离线的信用卡管理工具，致力于为用户提供安全、便捷的信用卡信息管理服务。软件无任何广告，所有功能均可免费使用，无需担心任何使用限制。
...
| 版本 | 发布日期 | 下载 | 说明 |
|:----:|:--------:|:----:|:-----|
| v1.5.4 | 2026-04-28 | [📥 下载 APK](releases/app-release1.5.4.apk) | 优化银行管理界面，移除拖动限制，调整颜色选择器参数 |
| v1.5.3 | 2026-04-29 | [📥 下载 APK](releases/app-release1.5.3.apk) | 新增银行管理界面和银行选择器组件，调整优化菜单入口 |
